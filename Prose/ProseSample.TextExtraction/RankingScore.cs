...
namespace AngularData.Prose.ProseSample.TextExtraction
{
    public class RankingScore : Feature<double>
    {
        ...
        public IFeature ExternScore => new AngularData.Prose.ProseSample.Substrings.Semantics.RankingScore(Grammar.GrammarReferences["Substrings"]);
