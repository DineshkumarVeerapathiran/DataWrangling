...
using static AngularData.Prose.Prose.Utils;


namespace AngularData.Prose.Prose
{
    public class program
    {
        ...
        private static void LoadAndTestSubstrings()
        {
            var grammar = LoadGrammar("ProseSample.Substrings.grammar",
                CompilerReference.FromAssemblyFiles(typeof(StringRegion).GetTypeInfo().Assembly,
                                                    typeof(AngularData.Prose.ProseSample.Substrings.Semantics.Semantics).GetTypeInfo().Assembly,
            ...
            Learn(grammar, spec, new AngularData.Prose.ProseSample.Substrings.Semantics.RankingScore(grammar), new AngularData.Prose.ProseSample.Substrings.Semantics.WitnessFunctions(grammar));
        ...
        private static void TestFlashFillBenchmark(Grammar grammar, string benchmark, int exampleCount = 2)
        {
            ...
            ProgramNode program = Learn(grammar, spec, new AngularData.Prose.ProseSample.Substrings.Semantics.RankingScore(grammar),
                                        new AngularData.Prose.ProseSample.Substrings.Semantics.WitnessFunctions(grammar));
        ...
        private static void LoadAndTestTextExtraction()
        {
            var grammar = LoadGrammar("ProseSample.TextExtraction.grammar",
                CompilerReference.FromAssemblyFiles(typeof(Substring).GetTypeInfo().Assembly,
                                                    typeof(AngularData.Prose.ProseSample.TextExtraction.Semantics).GetTypeInfo().Assembly));
        ...
        private static void TestExtractionBenchmark(Grammar grammar, string benchmark)
        {
            ...
            ProgramNode program = Learn(grammar, spec, new AngularData.Prose.ProseSample.TextExtraction.RankingScore(grammar),
                                        new AngularData.Prose.ProseSample.TextExtraction.WitnessFunctions(grammar));
